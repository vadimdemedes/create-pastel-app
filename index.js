...
const createPastelApp = (
	...
	const templatePath = javascript ? 'templates/js' : 'templates/ts';
				...
				task() {
					...
					return new Listr([
						...
						},
						{
							...
							enabled: () => javascript,
							async task() {
								await makeDir(toPath(projectDirectoryPath, 'source/commands'));

								await fs.copyFile(
									fromPath('source/commands/index.js'),
									toPath(projectDirectoryPath, 'source/commands/index.js'),
								);
						...
						},
						{
							...
							async task() {
								...
								await fs.copyFile(
									fromPath('source/commands/index.tsx'),
									toPath(projectDirectoryPath, 'source/commands/index.tsx'),
								);
...
export default createPastelApp;
